...
public class Cinema {
    ...
    private static void buyTicket(char[][] room) {
        ...
        while (!success) {
            ...
            System.out.println("Enter a seat number in the " + rowNumber + " row:");
    ...
    private static boolean hasPurchased(char[][] room, int rowNumber, int seatNumber) {
        return room[rowNumber][seatNumber] == 'T';
    }
    ...
    private static void printRoom(char[][] room) {
        System.out.println("Cinema Room Status:");
        System.out.print("  ");
